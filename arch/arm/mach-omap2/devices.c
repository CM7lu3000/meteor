...
static int omap_mcspi_init(struct omap_hwmod *oh, void *user)
{
	...
	case 0:
		...
		break;
	case 1:
//--[[ LGE_UBIQUIX_MODIFIED_START : scchoi@ubiquix.com [2011-06-30] - Added JUSTIN feature
#if defined(CONFIG_PRODUCT_LGE_HUB) || defined(CONFIG_PRODUCT_LGE_JUSTIN)
		...
		pdata->fifo_depth = 0;
#endif		
//--]] LGE_UBIQUIX_MODIFIED_END : scchoi@ubiquix.com [2011-06-30] - Added JUSTIN feature
		break;
	case 2:
...
//--[[ LGE_UBIQUIX_MODIFIED_START : jhyou79@mnbt.co.kr [110808] - for uses bcm4329	
#ifdef CONFIG_PRODUCT_LGE_HUB
//--[[ LGE_UBIQUIX_MODIFIED_START : [jhyou79@mnbt.co.kr] - for wifi, uses wl1271
#ifdef CONFIG_TIWLAN_SDIO	
	if (ctrl_nr == CONFIG_TIWLAN_MMC_CONTROLLER)
	{
		printk("rt5604: %s: ---- mmc == CONFIG_TIWLAN_MMC_CONTROLLER\n", __func__);
		name = "TIWLAN_SDIO";
	}
#endif
//--]] LGE_UBIQUIX_MODIFIED_END : [jhyou79@mnbt.co.kr]- for wifi, uses wl1271
#endif
//--]] LGE_UBIQUIX_MODIFIED_END : jhyou79@mnbt.co.kr [110808] - for uses bcm4329
