/*
 * linux/arch/arm/mach-omap2/board-black-debug.c
 *
...
struct platform_device black_ram_console_device = {
	.name = "ram_console",
	.id = -1,
	.num_resources = 1,
...
//--[[ LGE_UBIQUIX_MODIFIED_START : shyun@ubiquix.com [2011.08.28] - Not used in Black_Froyo
...
//--]] LGE_UBIQUIX_MODIFIED_END : shyun@ubiquix.com [2011.08.28]- Not used in Black_Froyo
...
static int lge_black_panic_event(struct notifier_block *this,
...
static int lge_black_reboot_event(struct notifier_block *this,
...
struct notifier_block lge_black_panic_nb = {
	.notifier_call = lge_black_panic_event,
};

struct notifier_block lge_black_reboot_nb = {
	.notifier_call = lge_black_reboot_event,
};

extern int register_reboot_notifier(struct notifier_block *nb);

static int black_debug_init(void)
{
printk("%s\n", __func__);
	atomic_notifier_chain_register(&panic_notifier_list, &lge_black_panic_nb);
	register_reboot_notifier(&lge_black_reboot_nb);
	return 0;
}

module_init(black_debug_init);
