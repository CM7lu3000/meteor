...
/* 20110601, mschung@ubiquix.com, set ID referencing HUB's froyo implementation. */
...
#define LGE_USB_VENDOR_ID		0x1004 /* 20110601, mschung@ubiquix.com, set ID referencing HUB's froyo implementation. */
...
*/
#if defined(CONFIG_PRODUCT_LGE_HUB)
#define LGE_USB_VENDOR_NAME 		"LGE"
#define LGE_USB_DEVICE_NAME			"LU3000"
#elif defined(CONFIG_PRODUCT_LGE_JUSTIN)
#define LGE_USB_VENDOR_NAME 		"LGE"
#define LGE_USB_DEVICE_NAME			"LU6800"
#elif defined(CONFIG_PRODUCT_LGE_BLACK)
#define LGE_USB_VENDOR_NAME 		"LGE"
#define LGE_USB_DEVICE_NAME			"KU5900"
...
#elif defined(CONFIG_not_defined_yet)
		.product_id     = LGE_USB_PRODUCT_ID,
...
#if defined(CONFIG_PRODUCT_LGE_HUB)||defined(CONFIG_PRODUCT_LGE_BLACK)||defined(CONFIG_PRODUCT_LGE_JUSTIN)
	.product_name		= LGE_USB_DEVICE_NAME,
#else
...
static struct usb_mass_storage_platform_data usbms_plat = {
	.vendor		= LGE_USB_VENDOR_NAME,
	.product	= LGE_USB_DEVICE_NAME,
	.release	= 0xFFFF,
	.nluns		= 1,
};
...
#if defined(CONFIG_PRODUCT_LGE_HUB)
	ret_check = snprintf(device_serial, MAX_USB_SERIAL_NUM, "%08X%08X%08X%08X",
