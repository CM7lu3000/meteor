/*
 * linux/arch/arm/mach-omap2/board-black-camera.c
 *
...
struct imx072_platform_data black_imx072_platform_data = {
...
struct dw9716_platform_data black_dw9716_platform_data = {
...
struct rt8515_platform_data black_rt8515_data = {
	.init		= rt8515_init,
	.exit		= rt8515_exit,
...
struct yacd5b1s_platform_data black_yacd5b1s_platform_data = {
...
void __init black_cam_init(void)
{
...
//--[[ LGE_UBIQUIX_MODIFIED_START : ymjun@mnbt.co.kr [2011.08.25] - CAM
		omap_mux_init_gpio(RT8515_FLINH_GPIO, OMAP_PIN_OUTPUT);  
//--]] LGE_UBIQUIX_MODIFIED_END : ymjun@mnbt.co.kr [2011.08.25] - CAM
