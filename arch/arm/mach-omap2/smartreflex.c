...
//--[[ LGE_UBIQUIX_MODIFIED_START : scchoi@ubiquix.com [2011.07.14] - Merged with justin's source.
int omap3_sr_init_check = 0; //20110406 ws.yang@lge.com
//--]] LGE_UBIQUIX_MODIFIED_END : scchoi@ubiquix.com [2011.07.14] - Merged with justin's source.
...
//--[[ LGE_UBIQUIX_MODIFIED_START : scchoi@ubiquix.com [2011.07.14] - Merged with justin's source.
	omap3_sr_init_check = 1;
	if (omap3_sr_init_check)
	{
//		printk("[%s] omap3_sr_init_check(%d)",__FUNCTION__, omap3_sr_init_check);		
	}		
//--]] LGE_UBIQUIX_MODIFIED_END : scchoi@ubiquix.com [2011.07.14] - Merged with justin's source.
...
//--[[ LGE_UBIQUIX_MODIFIED_START : scchoi@ubiquix.com [2011.07.14] - Merged with justin's source.
	omap3_sr_init_check = 0; //20110406 ws.yang@lge.com
//--]] LGE_UBIQUIX_MODIFIED_END : scchoi@ubiquix.com [2011.07.14] - Merged with justin's source.
	if (!sr_info) {
	...
	(void) debugfs_create_file("autocomp", S_IRUGO | S_IWUSR | S_IWGRP, dbg_dir,
				(void *)sr_info, &pm_sr_fops);
	(void) debugfs_create_file("errweight", S_IRUGO | S_IWUSR | S_IWGRP, dbg_dir,
				&sr_info->err_weight, &sr_params_fops);
	(void) debugfs_create_file("errmaxlimit", S_IRUGO | S_IWUSR | S_IWGRP, dbg_dir,
				&sr_info->err_maxlimit, &sr_params_fops);
	(void) debugfs_create_file("errminlimit", S_IRUGO | S_IWUSR | S_IWGRP, dbg_dir,
