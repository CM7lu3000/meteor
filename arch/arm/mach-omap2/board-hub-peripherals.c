...
/* LGE_UBIQUIX_MODIFIED_START : shyun@ubiquix.com [2011-06-16] - Not Support MPL/MPU */
/*
#ifdef CONFIG_HUB_SENSORS_MPL
#include <linux/mpu.h>
#endif
*/
/* LGE_UBIQUIX_MODIFIED_END : shyun@ubiquix.com [2011-06-16] - Not Support MPL/MPU */
...
//--[[ LGE_UBIQUIX_MODIFIED_START : nullcha@mnbt.co.kr - Add header file for wl127x rfkill
...
#define HUB_BACKLIGHT_ADDRESS 0x60
...
// 20100619 jh.koo@lge.com Hub key [START_LGE]
    ...
    KEY(2, 1, KEY_TESTMODE_UNLOCK),		//2010.10.09 for pattern unlock. taesub.kim@lge.com

// 20101012 jh.koo@lge.com [START_LGE]
	KEY(3, 0, KEY_1),
	KEY(3, 1, KEY_2),		
	KEY(3, 2, KEY_3),
	KEY(3, 3, KEY_4),
	...
	KEY(4, 2, KEY_9),
	KEY(4, 3, KEY_0),
	KEY(4, 4, KEY_SWITCHVIDEOMODE),
	KEY(4, 5, KEY_KBDILLUMTOGGLE),
	KEY(5, 0, KEY_UP),
	KEY(5, 1, KEY_DOWN),
	KEY(5, 2, KEY_SEND),
	KEY(5, 3, KEY_END),
	KEY(5, 4, KEY_CLEAR),
// 20101012 jh.koo@lge.com [END_LGE]
...
//--[[ LGE_UBIQUIX_MODIFIED_START : shyun@ubiquix.com [2011.08.26] - For ATS
...
#endif
//--]] LGE_UBIQUIX_MODIFIED_END : shyun@ubiquix.com [2011.08.26]- For ATS
...
static struct regulator_init_data hub_vmmc1 = {
	.constraints = {
		.min_uV			= 3000000,	// 20100630 taehwan.kim@lge.com Hub Sensor Power
		.max_uV			= 3000000,	// 20100630 taehwan.kim@lge.com Hub Sensor Power
		.valid_modes_mask	= REGULATOR_MODE_NORMAL
					| REGULATOR_MODE_STANDBY,
		.valid_ops_mask		= REGULATOR_CHANGE_VOLTAGE
					| REGULATOR_CHANGE_MODE
					| REGULATOR_CHANGE_STATUS,
//--[[ LGE_UBIQUIX_MODIFIED_START : shyun@ubiquix.com [2011.07.21] - "always_on => true" Rollback this feature. Power is always on. Confirm with mschung.
//--[[ LGE_UBIQUIX_MODIFIED_START : shyun@ubiquix.com [2011.07.15] - "always_on => false" Confirm with mschung
#if 1
        .always_on = true,
#else
        .always_on = false,
#endif
//--]] LGE_UBIQUIX_MODIFIED_END : shyun@ubiquix.com [2011.07.15]- "always_on => false" Confirm with mschung
//--]] LGE_UBIQUIX_MODIFIED_END : shyun@ubiquix.com [2011.07.21]- "always_on => true" Rollback this feature. Power is always on. Confirm with mschung.
        .boot_on = true,
	},
...
static struct regulator_init_data hub_vaux2= {
    .constraints = {
        /* LGE_CHANGE [chpark96@lge.com] New Rev.A Gyro 1.8 VIO */
        .min_uV                 = 1800000,
        .max_uV                 = 1800000,
...
static struct twl4030_platform_data hub_twldata = {
	...
	.vsim		= &hub_vsim,
	.vpll2		= &hub_vpll2,
//	.vdac		= &hub_vdac,		// scchoi@ubiquix.com
...
/* LGE_UBIQUIX_MODIFIED_START : shyun@ubiquix.com [2011-06-16] - Proximity Sensor Support */
#if (defined(CONFIG_HUB_SENSORS) && (defined(CONFIG_HUB_PROXI_SENSOR)))
	{
		 I2C_BOARD_INFO("hub_proxi", 0x44),	 		
	},
#endif
/* LGE_UBIQUIX_MODIFIED_END : shyun@ubiquix.com [2011-06-16] - Proximity Sensor Support */
...
#endif
/* LGE_UBIQUIX_MODIFIED_START : shyun@ubiquix.com [2011-06-16] - Accelerometer Sensor Support */
#if (defined(CONFIG_HUB_SENSORS) && (defined(CONFIG_HUB_KXTF9)))
	{
		I2C_BOARD_INFO("kxtf9", 0x0F),
	},
#endif
/* LGE_UBIQUIX_MODIFIED_END : shyun@ubiquix.com [2011-06-16] - Accelerometer Sensor Support */

/* LGE_UBIQUIX_MODIFIED_START : shyun@ubiquix.com [2011-06-16] - Compass Sensor Support */
#if (defined(CONFIG_HUB_SENSORS) && (defined(CONFIG_HUB_COMPASS)))
	{
		I2C_BOARD_INFO("hub_akm8973",0x1C),
	},
#endif
/* LGE_UBIQUIX_MODIFIED_END : shyun@ubiquix.com [2011-06-16] - Compass Sensor Support */
...
//--[[ LGE_UBIQUIX_MODIFIED_START : nullcha@mnbt.co.kr - Add TI BTIPS Rfkill
//TI BTIPS Rfkill addition Start
#ifdef CONFIG_WL127X_RFKILL
static struct wl127x_rfkill_platform_data wl127x_plat_data = {
	.bt_nshutdown_gpio = 16, 	/* Bluetooth Enable GPIO */
	.fm_enable_gpio = -1,		/* FM Enable GPIO */ /*junyeop.kim@lge.com, 2010-04-05 TI patch*/
};

static struct platform_device hub_wl127x_device = {
	.name           = "wl127x-rfkill",
	.id             = -1,
...
//--[[ LGE_UBIQUIX_MODIFIED_START : nullcha@mnbt.co.kr - Add TI BTIPS Rfkill Device
#ifdef CONFIG_WL127X_RFKILL
        &hub_wl127x_device,
#endif
//--]] LGE_UBIQUIX_MODIFIED_START : nullcha@mnbt.co.kr - Add TI BTIPS Rfkill Device
...
/* scchoi@ubiquix.com merge hub to black */
#if 0
#if 1
