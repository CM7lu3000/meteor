...
//LGE_LU6800_S 20101215 kyungrae.jo@lge.com, Justin LCD Backlight
#if defined(CONFIG_PRODUCT_LGE_JUSTIN)
#include "mach/lm3528.h"
#endif
//LGE_LU6800_E 20101215 kyungrae.jo@lge.com, Justin LCD Backlight
...
#define JUSTIN_TDMB_IRQ_GPIO 		29
#endif
...
#define JUSTIN_TS_I2C_INT_GPIO 35
...
extern struct platform_device justin_ram_console_device;
#endif
...
extern struct imx072_platform_data justin_imx072_platform_data;
extern struct dw9716_platform_data justin_dw9716_platform_data;
extern struct rt8515_platform_data justin_rt8515_data;
#endif
...
extern struct mt9v113_platform_data justin_mt9v113_platform_data;
#endif
//--]] LGE_UBIQUIX_MODIFIED_END : ymjun@mnbt.co.kr [2011.07.26] - CAM

#ifdef CONFIG_VIDEO_OMAP3
extern void justin_cam_init(void);
#else
#define justin_cam_init()	NULL
#endif
...
//extern struct regulator_init_data justin_vdac;
extern struct regulator_init_data justin_vdsi;
extern void justin_lcd_tv_panel_init(void);

static int board_keymap[] = {
//--[[ LGE_UBIQUIX_MODIFIED_START : shyun@ubiquix.com [2011.07.12] - Justin keymap feature modified.
#if defined(CONFIG_PRODUCT_LGE_JUSTIN)
	KEY(0, 0, KEY_HOME),
...
#endif	
//--]] LGE_UBIQUIX_MODIFIED_END : shyun@ubiquix.com [2011.07.12]- Justin keymap feature modified.
};
...
static struct twl4030_keypad_data justin_kp_twl4030_data = {
...
static int justin_reset_keys_up[] = {
        0
};

static struct keyreset_platform_data justin_reset_keys_pdata = {
	/* .crash_key = KEY_RIGHTSHIFT, */
	.keys_up = justin_reset_keys_up,
	.keys_down = {
		KEY_POWER,
		KEY_VOLUMEUP,
		0
...
struct platform_device justin_reset_keys_device = {
         .name = KEYRESET_NAME,
         .dev.platform_data = &justin_reset_keys_pdata,
};

//#define CONFIG_LGE_SLEEP_HUB
#ifdef CONFIG_LGE_MTC_ETA//hak.lee@lge.com
struct platform_device justin_mtc_eta_log_device = {
...
static struct twl4030_power_data justin_t2scripts_data = {
	.scripts = twl4030_scripts,
	.num = ARRAY_SIZE(twl4030_scripts),
	.resource_config = twl4030_rconfig,
};

static struct regulator_consumer_supply justin_vmmc1_supply = {
	.supply		= "vmmc1",
};

static struct regulator_consumer_supply justin_vsim_supply = {
	.supply		= "vmmc_aux",
};

static struct regulator_consumer_supply justin_vmmc2_supply = {
	.supply		= "vmmc2",
};

/* VMMC1 for VT_CAM_DRV_2.8V */
static struct regulator_init_data justin_vmmc1 = {
	.constraints = {
		.min_uV			= 2850000,
		.max_uV			= 2850000,
	...
	.consumer_supplies      = &justin_vmmc1_supply,
};

/* VMMC2 for MMC2 card - eMMC */
static struct regulator_init_data justin_vmmc2 = {
	.constraints = {
		.min_uV			= 1850000,
		.max_uV			= 1850000,
		.apply_uV		= true,
...
/*LGE_CHANGE_E sunggyun.yu@lge.com*/
	...
	.num_consumer_supplies  = 1,
	.consumer_supplies      = &justin_vmmc2_supply,
};

/* VSIM for 1.8V_WLAN */
static struct regulator_init_data justin_vsim = {
	.constraints = {
		.min_uV			= 1800000,
		.max_uV			= 3000000,
		.valid_modes_mask	= REGULATOR_MODE_NORMAL
...
#if defined(CONFIG_PRODUCT_LGE_JUSTIN)  //TI_Feature ?BT
/*
...
/* LGE_UPDATE_E, jaewoo56.lee@lge.com, Slow of Bluetooth UART issue */
	...
	.num_consumer_supplies  = 1,
	.consumer_supplies      = &justin_vsim_supply,
};

static struct regulator_consumer_supply justin_vaux1_supply = {
	.supply		= "vaux1",
};
static struct regulator_init_data justin_vaux1= {
	.constraints = {
		.min_uV			= 2800000,
		.max_uV			= 2800000,
		.apply_uV		= true,
	...
	.num_consumer_supplies  = 1,
	.consumer_supplies      = &justin_vaux1_supply,
};
...
static struct regulator_init_data justin_vaux2= {
	.constraints = {
		.min_uV                 = 2800000,
		.max_uV                 = 2800000,
		.apply_uV		= true,
...
static struct regulator_consumer_supply justin_vpll2_supply = {
    .supply 	= "vpll2",
};

static struct regulator_init_data justin_vpll2 = {
	.constraints = {
		.min_uV = 1800000,
		.max_uV = 1800000,
		.apply_uV = true,
	...
	.num_consumer_supplies = 1,
	.consumer_supplies = &justin_vpll2_supply,	
};

static struct regulator_consumer_supply justin_vdac_supply = {
	.supply         = "vdac",
};

static struct regulator_init_data justin_vdac = {
	.constraints = {
		.min_uV                 = 1800000,
		.max_uV                 = 1800000,
		.apply_uV = true,
...
/*LGE_CHANGE_E sunggyun.yu@lge.com*/
	...
	.num_consumer_supplies  = 1,
	.consumer_supplies      = &justin_vdac_supply,
};

static int justin_twl_gpio_setup(struct device *dev,
...
//	mmc[0].gpio_cd = gpio + 0;
	...
	*/
	//justin_vmmc1_supply.dev = mmc[0].dev;	// 20100630 taehwan.kim@lge.com Hub Sensor Power
	//justin_vsim_supply.dev = mmc[0].dev;
	//justin_vmmc2_supply.dev = mmc[1].dev;	// 20100630 taehwan.kim@lge.com Hub Sensor Power

	return 0;
}


static int justin_batt_table[] = {
/* 0 C*/
...
static struct twl4030_bci_platform_data justin_bci_data = {
	.battery_tmp_tbl	= justin_batt_table,
	.tblsize		= ARRAY_SIZE(justin_batt_table),
};

static struct twl4030_usb_data justin_usb_data = {
	.usb_mode	= T2_USB_MODE_ULPI,
};

static struct twl4030_gpio_platform_data justin_gpio_data = {
	.gpio_base	= OMAP_MAX_GPIO_LINES,
	.irq_base	= TWL4030_GPIO_IRQ_BASE,
	.irq_end	= TWL4030_GPIO_IRQ_END,
	.setup		= justin_twl_gpio_setup,
/*LGE_START_S sunggyun.yu@lge.com for touch key led*/
////	.use_leds	= 1,
/*LGE_START_E sunggyun.yu@lge.com for touch key led*/
};

static struct twl4030_madc_platform_data justin_madc_data = {
	.irq_line	= 1,
};

static struct twl4030_codec_audio_data justin_audio_data = {
	.audio_mclk = 26000000,
...
static struct twl4030_codec_data justin_codec_data = {
	.audio_mclk = 26000000,
	.audio = &justin_audio_data,
};

static struct twl4030_platform_data justin_twldata = {
	.irq_base	= TWL4030_IRQ_BASE,
	.irq_end	= TWL4030_IRQ_END,

	/* platform_data for children goes here */
	.bci		= &justin_bci_data,
	.madc		= &justin_madc_data,
	.usb		= &justin_usb_data,
	.gpio		= &justin_gpio_data,
	.keypad		= &justin_kp_twl4030_data,
	.codec		= &justin_codec_data,
	.power 		= &justin_t2scripts_data,
	.vmmc1		= &justin_vmmc1,
	.vmmc2		= &justin_vmmc2,
	.vsim		= &justin_vsim,
	.vpll2		= &justin_vpll2,
	.vdac		= &justin_vdac,
	.vaux1		= &justin_vaux1,	// 20100716 jh.koo@lge.com Hub Vibrator Power
	.vaux2		= &justin_vaux2,	// 20100630 taehwan.kim@lge.com Hub Sensor Power
};

//--[[ LGE_UBIQUIX_MODIFIED_START : jslee@ubiquix.com [2011.06.27] - j_froyo merge
//LGE_LU6800_S 20101215 kyungrae.jo@lge.com, Justin LCD Backlight
#if defined(CONFIG_PRODUCT_LGE_JUSTIN)
static struct lm3528_platform_data justin_lm3528_data;
#endif
//LGE_LU6800_E 20101215 kyungrae.jo@lge.com, Justin LCD Backlight
//--[[ LGE_UBIQUIX_MODIFIED_END : jslee@ubiquix.com [2011.06.27] - j_froyo merge

static struct i2c_board_info __initdata justin_i2c_boardinfo[] = {
	{
		I2C_BOARD_INFO("twl5030", 0x48),
		.flags		= I2C_CLIENT_WAKE,
		.irq		= INT_34XX_SYS_NIRQ,
		.platform_data	= &justin_twldata,
	},
};

// 20100619 jh.koo@lge.com Hub touchscreen [START_LGE]
static void justin_synaptics_dev_init(void)
{
	/* Set the ts_gpio pin mux */
	omap_mux_init_signal("gpio_35", OMAP_PIN_INPUT);

	if (gpio_request(JUSTIN_TS_I2C_INT_GPIO, "touch") < 0) {
		printk(KERN_ERR "can't get synaptics pen down GPIO\n");
		return;
	}
	gpio_direction_input(JUSTIN_TS_I2C_INT_GPIO);
// prime@sdcmicro.com Fix the compilation error in 2.6.35 kernel [START]
//	omap_set_gpio_debounce(JUSTIN_TS_I2C_INT_GPIO, 1);
//	omap_set_gpio_debounce_time(JUSTIN_TS_I2C_INT_GPIO, 0xa);
	gpio_set_debounce(JUSTIN_TS_I2C_INT_GPIO, 0xa);
// prime@sdcmicro.com Fix the compilation error in 2.6.35 kernel [END]
}

static struct synaptics_i2c_rmi_platform_data justin_ts_synaptics_platform_data[] = {
	{
		.version	= 0x0,
...
static struct i2c_board_info __initdata justin_i2c_bus2_info[] = {
// 20100629 jh.koo@lge.com Hub Backlight [START_LGE]
	{
		//I2C_BOARD_INFO("justin_i2c_bl", JUSTIN_BACKLIGHT_ADDRESS),
#if defined(CONFIG_BACKLIGHT_AAT2870)
		I2C_BOARD_INFO("aat2870_i2c_bl", AAT2870_BACKLIGHT_ADDRESS),
#endif
//--[[ LGE_UBIQUIX_MODIFIED_START : jslee@ubiquix.com [2011.06.27] - j_froyo merge
//LGE_LU6800_S 20101215 kyungrae.jo@lge.com
			I2C_BOARD_INFO(LM3528_I2C_NAME, LM3528_I2C_ADDR),
			.platform_data = &justin_lm3528_data,
//LGE_LU6800_E 20101215 kyungrae.jo@lge.com
//--[[ LGE_UBIQUIX_MODIFIED_END : jslee@ubiquix.com [2011.06.27] - j_froyo merge
...
// 20100619 jh.koo@lge.com Hub touchscreen [START_LGE]
	{
		I2C_BOARD_INFO("justin_synaptics_ts",	0x20),
		.platform_data = &justin_ts_synaptics_platform_data,
		.irq = OMAP_GPIO_IRQ(JUSTIN_TS_I2C_INT_GPIO),
	},
//--[[ LGE_UBIQUIX_MODIFIED_START : shyun@ubiquix.com [2011.07.12] - keytouch feature added.
	{
		I2C_BOARD_INFO("justin_keytouch",	(0x2C)),
	},		
//--]] LGE_UBIQUIX_MODIFIED_END : shyun@ubiquix.com [2011.07.12]- keytouch feature added.
...
#endif
#ifdef CONFIG_OMAP2_DSS_HDMI  // == 2011.05.11 === hycho@ubiquix.com
	// 4. HDMI_TX
	{
		I2C_BOARD_INFO(HDMI_TX_NAME,  TDA998X_I2C_SLAVEADDRESS),
	},
	// 4. HDMI_CEC
	{
		I2C_BOARD_INFO(HDMI_CEC_NAME,  TDA998XCEC_I2C_SLAVEADDRESS),
	},
#endif
...
static struct i2c_board_info __initdata justin_i2c_bus3_info[] = {
//--[[ LGE_UBIQUIX_MODIFIED_START : shyun@ubiquix.com [2011.07.21] - Justin sensor feature
#ifdef CONFIG_PRODUCT_LGE_JUSTIN

/* Proximity Sensor */
#if defined(CONFIG_BJ_PROXI_SENSOR)
	{
		I2C_BOARD_INFO("justin_proxi", 0x44),
	},
#endif
...
/* Compass Sensor */
	...
	{
		I2C_BOARD_INFO("justin_akm8973",0x0D),
	},	
#endif
...
#endif
#endif	//#ifdef CONFIG_PRODUCT_LGE_JUSTIN

//--]] LGE_UBIQUIX_MODIFIED_END : shyun@ubiquix.com [2011.07.21]- Justin sensor feature
...
//--[[ LGE_UBIQUIX_MODIFIED_START : shyun@ubiquix.com [2011.07.21] - Not used this feature in Justin.
#if 0
...
#endif
//--]] LGE_UBIQUIX_MODIFIED_END : shyun@ubiquix.com [2011.07.21]- Not used this feature in Justin.

#if (defined(CONFIG_VIDEO_IMX072) || defined(CONFIG_VIDEO_IMX072_MODULE)) 
	{
		I2C_BOARD_INFO("imx072", IMX072_I2C_ADDR),
		.platform_data = &justin_imx072_platform_data,
	},
		
	{
		I2C_BOARD_INFO(DW9716_NAME,  DW9716_AF_I2C_ADDR),
		.platform_data = &justin_dw9716_platform_data,
	},
#endif
...
//--[[ LGE_UBIQUIX_MODIFIED_START : ymjun@mnbt.co.kr [2011.07.26] - CAM
#if (defined(CONFIG_VIDEO_MT9V113) || defined(CONFIG_VIDEO_MT9V113_MODULE)) 
	{
		...
		.platform_data = &justin_mt9v113_platform_data,
	},
#endif
//--]] LGE_UBIQUIX_MODIFIED_END : ymjun@mnbt.co.kr [2011.07.26] - CAM
...
{
	omap_register_i2c_bus(1, 400, NULL, justin_i2c_boardinfo,
			ARRAY_SIZE(justin_i2c_boardinfo));
	omap_register_i2c_bus(2, 400, NULL,justin_i2c_bus2_info,
			ARRAY_SIZE(justin_i2c_bus2_info));
	omap_register_i2c_bus(3, 400, NULL,justin_i2c_bus3_info, 
			ARRAY_SIZE(justin_i2c_bus3_info));// 20100624 taehwan.kim@lge.com, add the i2c3 platform device
	return 0;
}

// 20100624 junyeop.kim@lge.com, add the headset platform device [START_LGE]
static struct gpio_switch_platform_data justin_headset_data = {
	.name = "h2w",
	.gpio = 170,
};

static struct platform_device lge_justin_headset_device = {
	.name		= "hub_headset",
	.id		= -1,
	.dev.platform_data = &justin_headset_data,
};
...
static struct platform_device justin_charging_ic_device = {
...
#if (defined(CONFIG_VIDEO_IMX072) || defined(CONFIG_VIDEO_IMX072_MODULE)) 
static struct platform_device justin_rt8515_device = {
	.name		= "rt8515",
	.id			= -1,
	.dev		= {
 	.platform_data = &justin_rt8515_data,
	},
};
...
static struct platform_device justin_vibrator_device = {
	.name	 = "hub_vibrator",
	.id		= -1,
};
#endif
...
/* LGE_CHANGE_S, hyun.seungjin@lge.com, 2011-02-23, Move directory from driver/hub to misc */
//--[[ LGE_UBIQUIX_MODIFIED_START : shyun@ubiquix.com [2011.07.21] - CONFIG_HUB_MOTION -> CONFIG_BJ_MOTION_SENSOR
//#ifdef CONFIG_HUB_MOTION
#ifdef CONFIG_BJ_MOTION_SENSOR
//--]] LGE_UBIQUIX_MODIFIED_END : shyun@ubiquix.com [2011.07.21]- CONFIG_HUB_MOTION -> CONFIG_BJ_MOTION_SENSOR
...
static struct platform_device justin_bcm4329_device = {
...
#ifdef BRCM_BT_WAKE
static struct platform_device justin_bcm4329_btwake_device = {
...
static struct platform_device justin_gps_gpio =
{
	.name = "hub_gps_gpio",
	.id   = -1,
};
...
/*(+) by nus */
static struct platform_device justin_modem_device=
{
		.name = "modem_ctrl",
		.id 	= -1,
};
...
static struct platform_device *justin_devices[] __initdata = {
	/* 20100326 junyeop.kim@lge.com for headset device */
	&lge_justin_headset_device, 
//	// 20100624 taehwan.kim@lge.com, add the charger platform device [START_LGE]
/* LGE_CHANGE_S [daewung.kim@lge.com] 2010-09-14, GPS_PORTING */
//	&justin_gps_gpio,
/* LGE_UPDATE_E [daewung.kim@lge.com] 2010-09-14 */
	&justin_charging_ic_device,
	// 20100624 taehwan.kim@lge.com, add the charger platform device [END_LGE]
...
//--[[ LGE_UBIQUIX_MODIFIED_START : ymjun@mnbt.co.kr [2011.07.26] - CAM
	...
	&justin_rt8515_device,		// 20100426 hyungwoo.ku@lge.com Flash driver for camera
//--]] LGE_UBIQUIX_MODIFIED_END : ymjun@mnbt.co.kr [2011.07.26] - CAM
#endif
#ifdef CONFIG_HUB_VIBRATOR
//	&justin_vibrator_device,	// 20100716 jh.koo@lge.com Hub Vibrator device
#endif
//	&justin_reset_keys_device,
/* LGE_UPDATE_S, jaewoo56.lee@lge.com, Bluetooth for Broadcom */
#ifdef CONFIG_LBEE9QMB_RFKILL
	&justin_bcm4329_device,
#endif // CONFIG_LBEE9QMB_RFKILL
/* LGE_UPDATE_E, jaewoo56.lee@lge.com, Bluetooth for Broadcom */
//hak.lee@lge.com 
#ifdef CONFIG_LGE_MTC_ETA
//	&justin_mtc_eta_log_device,
#endif
//hak.lee@lge.com end
#ifdef CONFIG_ANDROID_RAM_CONSOLE
	&justin_ram_console_device,
#endif
	&ers_kernel,

/* LGE_CHANGE_S, hyun.seungjin@lge.com, 2011-02-23, Move directory from driver/hub to misc */
//--[[ LGE_UBIQUIX_MODIFIED_START : shyun@ubiquix.com [2011.07.14] - CONFIG_HUB_MOTION -> CONFIG_BJ_MOTION_SENSOR
//#ifdef CONFIG_HUB_MOTION
#ifdef CONFIG_BJ_MOTION_SENSOR
//--]] LGE_UBIQUIX_MODIFIED_END : shyun@ubiquix.com [2011.07.14]- CONFIG_HUB_MOTION -> CONFIG_BJ_MOTION_SENSOR
/* LGE_CHANGE_S sglee76@lge.com Gyro */
...
#ifdef CONFIG_LBEE9QMB_RFKILL
#ifdef BRCM_BT_WAKE
//	&justin_bcm4329_btwake_device,
#endif	
#endif // CONFIG_LBEE9QMB_RFKILL
// 20101121 BT: dohyung10.lee@lge.com - For the BD Address Read /write [Start]
//	&bd_address_device,
// 20101121 BT: dohyung10.lee@lge.com - For the BD Address Read /write [End]
//--[[ LGE_UBIQUIX_MODIFIED_START : scchoi@ubiquix.com [2011.07.21] - Added modem device.
	&justin_modem_device,
//--[[ LGE_UBIQUIX_MODIFIED_END : scchoi@ubiquix.com [2011.07.21] - Added modem device.
/*(-) by nus */
};

/* sunggyun.yu@lge.com for GPIO_126, 127, 129 */
static void __init justin_mmc1_gpio_init(void)
{
	u32 reg;
...
static struct spi_board_info justin_ipc_spi_board_info[] __initdata = {
#if 0
	{
		.modalias = "ifxn721",
		.bus_num = 1,
...
static void __init justin_ipc_spi_init(void)
{
	spi_register_board_info(justin_ipc_spi_board_info, ARRAY_SIZE(justin_ipc_spi_board_info));
}
#endif /* CONFIG_LGE_SPI */
...
static struct spi_board_info justin_tdmb_spi_board_info[] __initdata = {
	[0] = {
	       ...
	       .irq = OMAP_GPIO_IRQ(JUSTIN_TDMB_IRQ_GPIO),
	       },
};
...
static void __init justin_tdmb_spi_init(void)
{
	spi_register_board_info(justin_tdmb_spi_board_info, ARRAY_SIZE(justin_tdmb_spi_board_info));
}
#endif
...
#endif
static int __init justin_dev_init(void)
{
	max17043_init();
	bd2802_init();
	return 0;
...
void __init justin_peripherals_init(void)
{
	justin_mmc1_gpio_init();
	omap_i2c_init();
	platform_add_devices(justin_devices, ARRAY_SIZE(justin_devices));

	justin_synaptics_dev_init(); // 20100619 jh.koo@lge.com Hub touchscreen
...
#endif
#ifdef CONFIG_PRODUCT_LGE_JUSTIN
	justin_lcd_tv_panel_init();    // 20110628 jslee@ubiquix.com 
#endif
	usb_musb_init(&musb_board_data);
// prime@sdcmicro.com Added function to initialize SYS_NIRQ pin [START]
	enable_board_wakeup_source(); // 20110628 jslee@ubiquix.com
// prime@sdcmicro.com Added function to initialize SYS_NIRQ pin [END]
//--[[ LGE_UBIQUIX_MODIFIED_START : ymjun@mnbt.co.kr [2011.07.26] - CAM
	justin_cam_init();
//--]] LGE_UBIQUIX_MODIFIED_END : ymjun@mnbt.co.kr [2011.07.26] - CAM
...
//--[[ LGE_UBIQUIX_MODIFIED_START : ymjun@mnbt.co.kr [2011.07.01] - TDMB
#ifdef CONFIG_SPI_TDMB
	justin_tdmb_spi_init();
#endif
//--]] LGE_UBIQUIX_MODIFIED_END : ymjun@mnbt.co.kr [2011.07.01] - TDMB
}

/* scchoi@ubiquix.com merge justin to black */
/* 
module_init(justin_dev_init) 
*/
