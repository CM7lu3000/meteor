...
#else   // 20110505  hjpark@ubiquix.com 
#define RT8515_FLEN_GPIO  		137
#define RT8515_ENSET_S2C_GPIO  	139
#endif 
...
//--[[ LGE_UBIQUIX_MODIFIED_START : ymjun@mnbt.co.kr [2011.09.19] - CAM
        gpio_direction_output(SUBPM_ENABLE, 1);
//--]] LGE_UBIQUIX_MODIFIED_END : ymjun@mnbt.co.kr [2011.09.19] - CAM
...
//--[[ LGE_UBIQUIX_MODIFIED_START : ymjun@mnbt.co.kr [2011.08.04] - CAM
		omap_mux_init_gpio(RT8515_FLINH_GPIO, OMAP_PIN_OUTPUT);
//--]] LGE_UBIQUIX_MODIFIED_END : ymjun@mnbt.co.kr [2011.08.04] - CAM  
