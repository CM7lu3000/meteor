...
static void __init omap_black_map_io(void)
{
	omap2_set_globals_36xx();
	omap34xx_map_common_io();
}

static struct omap_board_config_kernel black_config[] __initdata = {
};

static void __init omap_black_init_irq(void)
{
	omap_board_config = black_config;
	omap_board_config_size = ARRAY_SIZE(black_config);
#ifndef CONFIG_LGE_SLEEP_HUB
...
static void __init omap_black_init(void)
{
	omap3_mux_init(board_mux, OMAP_PACKAGE_CBP);
	/* LGE_CHANGE_S, [younggil.lee@lge.com], 2011-05-04, <add Setting enable Wifi Host wakeup> */
	config_wlan_mux();
	/* LGE_CHANGE_E, [younggil.lee@lge.com], 2011-05-04, <add Setting enable Wifi Host wakeup> */
	black_peripherals_init();
...
static int __init black_opp_init(void)
{
...
device_initcall(black_opp_init);

MACHINE_START(LGE_HUB, "LGE BLACK board")
	.phys_io	= 0x48000000, /* L4_34XX_PHYS */
	.io_pg_offst	= ((0xfa000000 /* L4_34XX_VIRT */) >> 18) & 0xfffc,
	.boot_params	= 0x80000100,
	.map_io		= omap_black_map_io,
	.init_irq	= omap_black_init_irq,
	.init_machine	= omap_black_init,
	.timer		= &omap_timer,
MACHINE_END
