...
//--[[ LGE_UBIQUIX_MODIFIED_START : jhyou79@mnbt.co.kr [2011.12.03] - Cacao Talk Wake Up Issue (VOC)
	omap_mux_init_gpio(HUB_WIFI_IRQ_GPIO, OMAP_PIN_INPUT | OMAP_PIN_INPUT_PULLUP | OMAP_PIN_OFF_WAKEUPENABLE);
//--]] LGE_UBIQUIX_MODIFIED_END : jhyou79@mnbt.co.kr [2011.12.03] - Cacao Talk Wake Up Issue (VOC)
