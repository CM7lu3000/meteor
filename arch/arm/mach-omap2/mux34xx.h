...
#if 1
#define OMAP3_CONTROL_PADCONF_SIM_IO_OFFSET				0xa26
#define OMAP3_CONTROL_PADCONF_SIM_CLK_OFFSET			0xa24
#define OMAP3_CONTROL_PADCONF_SIM_PWRCTRL_OFFSET		0xa28
#define OMAP3_CONTROL_PADCONF_SIM_RST_OFFSET			0xa2a
#else
