...
extern int omap3_sr_init_check; //20110406 ws.yang@lge.com
...
/*//nthyunjin.yang for test
	if (omap3_sr_init_check == 0)  //20110406 ws.yang@lge.com
	{
		//		printk("[%s]: omap3_sr_init_check(%d) \n", __FUNCTION__, omap3_sr_init_check);       	
		return;
	}
*///nthyunjin.yang for test
//--]] LGE_UBIQUIX_MODIFIED_END : scchoi@ubiquix.com [2011.07.14] - Merged with justin's source.
