...
static irqreturn_t omap_hsmmc_cd_handler(int irq, void *dev_id)
{
	...
	if (host->suspended || gpio_get_value(10))
		return IRQ_HANDLED;
#else
	if (host->suspended)
		return IRQ_HANDLED;
...
/* LGE_CHANGE_S, [yoiunggil.lee@lge.com], 2011-04-04 BCM43291 P970 migration */
...
/* LGE_CHANGE_E, [yoiunggil.lee@lge.com], 2011-04-04 BCM43291 P970 migration */
