...
#elif defined(CONFIG_PRODUCT_LGE_BLACK)    /*  defined(CONFIG_MACH_LGE_JUSTIN) */
...
{
#if defined(CONFIG_PRODUCT_LGE_JUSTIN) || defined(CONFIG_PRODUCT_LGE_BLACK)	// dajin.kim temp code
	int ret;
	int retry = 3;
...
// 20100812 junyeop.kim@lge.com, reduce the pop noise when changing devices[END_LGE]
	...
	case HEADSET_AUDIO_MODE:
	    ...
	    case SPEAKER_HEADSET_DUAL_AUDIO_MODE : wm9093_write_table((wm9093_reg_type*)&wm9093_in2_to_out_hp_tab[0]);
			             ...
			             break;
#if 1//defined(CONFIG_PRODUCT_LGE_JUSTIN) || defined(CONFIG_PRODUCT_LGE_BLACK)			             
