...
/* core */
int new_dss_init(void); // == 2011.06.12 === hycho@ubiquix.com  
...
extern int HDMItoLCD_Interrupts_pass;
extern int HDMItoLCD_Configure_pass;
void HDMItoLCD_reg_rollback(void);
void new_dispc_dump_regs(void);
#endif
