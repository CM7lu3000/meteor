...
extern int cur_main_lcd_level; /* 20100825 jugwan.eom@lge.com / 20110707 hslee84@lge.com*/
...
// LGE_UPDATE
	...
	case FBIOBLANK:
		...
		unlock_fb_info(info);
		break;
        /* 20100709 jugwan.eom@lge.com For OnScreenPhone to get screen data FASTER  / 20110707 hslee84@lge.com*/
    case FBIOGET_SCREEN_DATA:
		if (system_state == SYSTEM_RUNNING) {
			ret = copy_to_user(argp, phys_to_virt(omap_readl(0x48050480)), 1536000) ? -EFAULT : 0;
		}
        break;
		/* 20100825 jugwan.eom@lge.com for OSP to check backlight status  / 20110707 hslee84@lge.com */
