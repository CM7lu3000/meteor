...
#define DEFAULT_BRIGHTNESS	0x69	// about 220 cd/m2
...
{
	printk("[jslee] lm3258_power_switch_#1.\n");
...
//		synaptics_keytouch_power_off();		20110617 jslee@ubiquix.com
//		synaptics_touch_power_off();
	...
	{
//	    	synaptics_keytouch_power_on();		20110617 jslee@ubiquix.com
...
#endif
#ifndef LJH_TEST
//	doing_wakeup = 0;		// 20110617 jslee@ubiquix.com
#endif
    return 0;
}
