...
//--[[ LGE_UBIQUIX_MODIFIED_START : shyun@ubiquix.com [2011.08.28] - Touch used this function
//static int aat2870_ldo_write(u8 reg , u8 val)
int aat2870_ldo_write(u8 reg , u8 val)
//--]] LGE_UBIQUIX_MODIFIED_END : shyun@ubiquix.com [2011.08.28]- Touch used this function
{
	int ret =  -1  ;
...
//--[[ LGE_UBIQUIX_MODIFIED_START : shyun@ubiquix.com [2011.08.28] - Touch used this function
EXPORT_SYMBOL(aat2870_ldo_write);
//--]] LGE_UBIQUIX_MODIFIED_END : shyun@ubiquix.com [2011.08.28]- Touch used this function
