...
static DEVICE_ATTR(motion_sleep_onoff,0666,NULL,motion_sleep_onoff_store);
static DEVICE_ATTR(motion_pwr_onoff,0666,NULL,motion_pwr_onoff_store);
...
#ifdef CONFIG_PRODUCT_LGE_JUSTIN//justin LCD resume speed up
