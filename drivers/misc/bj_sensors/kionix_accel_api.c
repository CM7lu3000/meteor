...
//--[[ LGE_UBIQUIX_MODIFIED_START : shyun@ubiquix.com [2011.08.11] - CONFIG_MACH_LGE_JUSTIN => CONFIG_PRODUCT_LGE_JUSTIN
//#if ( defined(CONFIG_DOMESTIC) && defined(CONFIG_MACH_LGE_JUSTIN) )
#if defined(CONFIG_PRODUCT_LGE_JUSTIN)
//--]] LGE_UBIQUIX_MODIFIED_END : shyun@ubiquix.com [2011.08.11]- CONFIG_MACH_LGE_JUSTIN => CONFIG_PRODUCT_LGE_JUSTIN
