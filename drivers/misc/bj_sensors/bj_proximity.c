...
{
//--[[ LGE_UBIQUIX_MODIFIED_START : shyun@ubiquix.com [2011.07.14] - Definition is modified.
//#if (defined(CONFIG_DOMESTIC) && defined(CONFIG_MACH_LGE_JUSTIN))
#if defined(CONFIG_PRODUCT_LGE_JUSTIN)
//--]] LGE_UBIQUIX_MODIFIED_END : shyun@ubiquix.com [2011.07.14]- Definition is modified.
...
//--[[ LGE_UBIQUIX_MODIFIED_START : shyun@ubiquix.com [2011.08.02] - CONFIG_MACH_LGE_HUB -> CONFIG_PRODUCT_LGE_BLACK (Black Feature)
#if defined(CONFIG_MACH_LGE_HEAVEN_REV_A) || defined(CONFIG_PRODUCT_LGE_BLACK) /*defined(CONFIG_MACH_LGE_HUB)*/
//--]] LGE_UBIQUIX_MODIFIED_END : shyun@ubiquix.com [2011.08.02]- CONFIG_MACH_LGE_HUB -> CONFIG_PRODUCT_LGE_BLACK (Black Feature)
	if(enable) {
...
//--[[ LGE_UBIQUIX_MODIFIED_START : shyun@ubiquix.com [2011.07.14] - Not used this feature.
#if 0
extern void omap_pm_cpu_set_freq(unsigned long f);
extern u32 te_cpu_idle_block;
EXPORT_SYMBOL(te_cpu_idle_block);
#endif
//--]] LGE_UBIQUIX_MODIFIED_END : shyun@ubiquix.com [2011.07.14]- Not used this feature.
...
//--[[ LGE_UBIQUIX_MODIFIED_START : shyun@ubiquix.com [2011.08.02] - CONFIG_MACH_LGE_HUB -> CONFIG_PRODUCT_LGE_BLACK (Black Feature)
#elif defined(CONFIG_PRODUCT_LGE_BLACK) /*defined(CONFIG_MACH_LGE_HUB)*/
//--]] LGE_UBIQUIX_MODIFIED_END : shyun@ubiquix.com [2011.08.02]- CONFIG_MACH_LGE_HUB -> CONFIG_PRODUCT_LGE_BLACK (Black Feature)
...
//--]] LGE_UBIQUIX_MODIFIED_END : shyun@ubiquix.com [2011.07.14]- Definition is modified.
  data->early_suspend.level = 45;//BL=50, TS=49, TK=48
	...
	printk("[shyun] hub_proxi_probe [OUT]\n");
...
//--[[ LGE_UBIQUIX_MODIFIED_START : shyun@ubiquix.com [2011.07.28] - Featuring is added.
	...
	{ "black_proxi", 0 },
#else
#error "Please confirm the product definition(Proximity)"
#endif
