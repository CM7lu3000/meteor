...
//--[[ LGE_UBIQUIX_MODIFIED_START : ymjun@mnbt.co.kr [2011.08.03] - CAM
...
#endif
//--]] LGE_UBIQUIX_MODIFIED_END : ymjun@mnbt.co.kr [2011.08.03] - CAM
...
int isp_s_crop(struct device *dev, struct v4l2_crop *a)
{
	...
	DPRINTK_ISPCTRL("@@@@ isp_s_crop: isp->pipeline.modules = 0x%x\n", isp->pipeline.modules);	
