...
//--[[ LGE_UBIQUIX_MODIFIED_START : ymjun@mnbt.co.kr [2011.07.29] - CAM
				#if defined(CONFIG_PRODUCT_LGE_JUSTIN) || defined(CONFIG_PRODUCT_LGE_BLACK)
				if (!(vdev->vdev_sensor_config.sensor_isp)){
				#endif
//--]] LGE_UBIQUIX_MODIFIED_END : ymjun@mnbt.co.kr [2011.07.29] - CAM
...
//--[[ LGE_UBIQUIX_MODIFIED_START : ymjun@mnbt.co.kr [2011.07.29] - CAM
#if defined(CONFIG_PRODUCT_LGE_JUSTIN) || defined(CONFIG_PRODUCT_LGE_BLACK)
	// LGE_DOM_UPDATE_S jongkyung.kim 2010/12/28 {
	// LGE_JUSTIN_S 20101209 jongkyung.kim@lge.com, sub cam VT rotation
	//if (rval && !vdev->vdev_sensor_config.sensor_isp) {
	if (rval) {
	// LGE_DOM_UPDATE_E jongkyung.kim 2010/12/28 }
#else // 
	if (rval && !vdev->vdev_sensor_config.sensor_isp) {
#endif
//--]] LGE_UBIQUIX_MODIFIED_END : ymjun@mnbt.co.kr [2011.07.29] - CAM
