...
//--[[ LGE_UBIQUIX_MODIFIED_START : scchoi@ubiquix.com [2011.06.23] - Added black and justin feature 
	...
	mdelay(5);
	lp8720_write_reg(lp8720_client, LP8720_LDO1_SETTING, LP8720_STARTUP_DELAY_3TS | 0x0C); //1.8v - HDMI 
	lp8720_write_reg(lp8720_client, LP8720_LDO2_SETTING, LP8720_STARTUP_DELAY_3TS | 0x1f); //3.3v - HDMI //2010-5-8 changhoony.lee@lge.com 
	lp8720_write_reg(lp8720_client, LP8720_LDO3_SETTING, LP8720_STARTUP_DELAY_3TS | 0x17); //2.7v
	lp8720_write_reg(lp8720_client, LP8720_LDO4_SETTING, LP8720_STARTUP_DELAY_3TS | 0x11); //1.8v
	lp8720_write_reg(lp8720_client, LP8720_LDO5_SETTING, LP8720_STARTUP_DELAY_3TS | 0x19); //2.8v
	lp8720_write_reg(lp8720_client, LP8720_BUCK_SETTING1, LP8720_STARTUP_DELAY_3TS | 0x09);
	lp8720_write_reg(lp8720_client, LP8720_BUCK_SETTING2, 0x09); //1.2v
	lp8720_write_reg(lp8720_client, LP8720_OUTPUT_ENABLE, 0x80 | lp8720_output_status);
	mdelay(5);
   //gpio_direction_output(pdata->en_gpio_num, 1);
...
#endif
//--]] LGE_UBIQUIX_MODIFIED_END : scchoi@ubiquix.com [2011.06.23]- Added black and justin feature. 
