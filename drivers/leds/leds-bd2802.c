...
#define BD2802_CURRENT_WHITE_MIN		0x00 /* 0mA */	// dajin.kim@lge.com chagned 0x05 -> 0x00 for lED off
...
// LGE_B_DOM_S 20101230 nttaejun.cho@lge.com, RGB Led
	if (system_rev >=2) //OVER REV.B
// LGE_B_DOM_E 20101230 nttaejun.cho@lge.com, RGB Led	
	{
		//bd2802_write_byte(led->client, BD2812_DCDCDRIVER, 0x00); //20110228 seven.kim@lge.com removed to prevent I2C2 Crash 
