...
/* S, 20110830, mschung@ubiquix.com, Modify start on condition for HUB, referencing HUB froyo. */
#if defined(CONFIG_PRODUCT_LGE_HUB) 
#define     STARTON_CONDITION   0xE3 /* WDOG|----|VBUS|    |    |    | CHG|PWON */
#else
#define     STARTON_CONDITION   0xEF /* WDOG|----|VBUS|    | RTC| USB| CHG|PWON */
#endif
/* E, 20110830, mschung@ubiquix.com, Modify start on condition for HUB, referencing HUB froyo. */
