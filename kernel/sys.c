...
extern char reset_mode; /* 20100531 jugwan.eom@lge.com for factory reset */
...
/* S, 20110809, mschung@ubiquix.com, Merge MUIC of HUB froyo (to do CTS test). */
#if defined(CONFIG_PRODUCT_LGE_HUB)
	printk("%s: hidden_reset_enabled %d\n", __func__, hidden_reset_enabled);
	/* 20100531 jugwan.eom@lge.com [START_LGE] */
	if (cmd) {
		printk("%s: cmd=%s\n", __func__, cmd);
        ...
        if (!strcmp(cmd, "recovery"))
			...
			reset_mode = 't';
		else if (!strcmp(cmd, "cpusb"))
			reset_mode = 'c';
		else if (!strcmp(cmd, "apusb"))
			reset_mode = 'a';
		else if (!strcmp(cmd, "erase_bcb"))
			reset_mode = 'e';
	}
	else
	{
		printk("%s: cmd is null\n", __func__);
	}
        /* 20100531 jugwan.eom@lge.com [END_LGE] */
#endif
/* E, 20110809, mschung@ubiquix.com, Merge MUIC of HUB froyo (to do CTS test). */
