...
/* LGE_UBIQUIX_MODIFIED_START : shyun@ubiquix.com [2011-05-30] - HUB sensor mpl include */
#if (defined(CONFIG_HUB_SENSORS_MPL) && defined(CONFIG_HUB_SENSORS_KXTF9))
#define CONFIG_MPU_SENSORS_KXTF9
#endif
/* LGE_UBIQUIX_MODIFIED_END : shyun@ubiquix.com [2011-05-30] - HUB sensor mpl include */

/* LGE_UBIQUIX_MODIFIED_START : shyun@ubiquix.com [2011-05-30] - HUB sensor mpl include */
#if (defined(CONFIG_HUB_SENSORS_MPL) && defined(CONFIG_HUB_SENSORS_AK8973))
#define	CONFIG_MPU_SENSORS_AK8973
#endif
/* LGE_UBIQUIX_MODIFIED_END : shyun@ubiquix.com [2011-05-30] - HUB sensor mpl include */
