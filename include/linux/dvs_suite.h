 ...
 */
#define DS_SRT_MM_TIMEOUT		100000		// 100 msec. It should not be larger than 1sec.
#define DS_SRT_UIE_TIMEOUT		100000		// 100 msec. It should not be larger than 1sec.
...
#define DS_AIDVS_INTERVAL_WINDOW_SIZE	200			/* 200 intervals in an window */
 ...
 */
#define DS_GPSCHEDVS_L0_INTERVAL_WINDOW_SIZE	100		/* 100 intervals in an window */
#define DS_GPSCHEDVS_L0_INTERVAL_WINDOW_LENGTH	10000	/* 10 msec in elapsed */
#define DS_GPSCHEDVS_L0_SPEEDUP_THRESHOLD	2000		/* 2 msec in fse */
#define DS_GPSCHEDVS_L0_SPEEDUP_INTERVAL	2000		/* 2 msec in fse */

#define DS_GPSCHEDVS_L1_INTERVAL_WINDOW_SIZE	100		/* 100 intervals in an window */
#define DS_GPSCHEDVS_L1_INTERVAL_WINDOW_LENGTH	25000	/* 25 msec in elapsed */
#define DS_GPSCHEDVS_L1_SPEEDUP_THRESHOLD	5000		/* 5 msec in fse */
#define DS_GPSCHEDVS_L1_SPEEDUP_INTERVAL	5000		/* 5 msec in fse */

#define DS_GPSCHEDVS_L2_INTERVAL_WINDOW_SIZE	100		/* 100 intervals in an window */
#define DS_GPSCHEDVS_L2_INTERVAL_WINDOW_LENGTH	50000	/* 50 msec in elapsed */
#define DS_GPSCHEDVS_L2_SPEEDUP_THRESHOLD	10000		/* 10 msec in fse */
#define DS_GPSCHEDVS_L2_SPEEDUP_INTERVAL	10000		/* 10 msec in fse */

#define DS_GPSCHEDVS_L3_INTERVAL_WINDOW_SIZE	100		/* 100 intervals in an window */
#define DS_GPSCHEDVS_L3_INTERVAL_WINDOW_LENGTH	100000	/* 100 msec in elapsed */
#define DS_GPSCHEDVS_L3_SPEEDUP_THRESHOLD	20000		/* 20 msec in fse */
#define DS_GPSCHEDVS_L3_SPEEDUP_INTERVAL	20000		/* 20 msec in fse */
