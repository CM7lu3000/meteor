...
//--[[ LGE_UBIQUIX_MODIFED_START : nullcha@mnbt.co.kr - change and add structure for IT
enum wl127x_devices {
	WL127X_BLUETOOTH = 0,
	WL127X_FM,
	WL127X_MAX_DEV,
...
//--]] LGE_UBIQUIX_MODIFED_END : nullcha@mnbt.co.kr - change and add structure for IT
#endif
