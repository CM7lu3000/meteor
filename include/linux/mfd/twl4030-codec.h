...
#endif	// #if defined(CONFIG_PRODUCT_LGE_JUSTIN) || defined(CONFIG_PRODUCT_LGE_BLACK) || defined(CONFIG_PRODUCT_LGE_HUB)
}voice_mode_enum;
...
#endif	// defined(CONFIG_PRODUCT_LGE_JUSTIN) || defined(CONFIG_PRODUCT_LGE_BLACK) || defined(CONFIG_PRODUCT_LGE_HUB)
