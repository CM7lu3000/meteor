...
#include <sound/tlv.h>
#if defined(CONFIG_PRODUCT_LGE_JUSTIN) || defined(CONFIG_PRODUCT_LGE_BLACK) || defined(CONFIG_PRODUCT_LGE_HUB)   // 20100618 junyeop.kim@lge.com, audio path [START_LGE] 
...
#if defined(CONFIG_PRODUCT_LGE_JUSTIN) // 20101214 seungdae.goh@lge.com justin gpio adjust
...
#if defined(CONFIG_PRODUCT_LGE_JUSTIN) || defined(CONFIG_PRODUCT_LGE_BLACK)
...
#endif
#endif // #if defined(CONFIG_PRODUCT_LGE_JUSTIN) || defined(CONFIG_PRODUCT_LGE_BLACK)
...
#if 0	//junyeop.kim@lge.com, call workaround in the mute case
// wake lock for usb connection
#include <linux/wakelock.h>
static struct wake_lock wake_lock_calling;
#endif
#define TWL_READ_REG_NO_CACHE 1
// [bsnoh@ubiquix][20110528] : Added code from froyo justin [End]
/*
 * twl4030 register cache & default register settings
 */
// [bsnoh@ubiquix][20110528] : Added code from froyo justin [Start]
#if defined(CONFIG_PRODUCT_LGE_JUSTIN)  // 20101231 seungdae.goh@lge.com HW_TUNNING
...
static const u8 twl4030_reg[TWL4030_CACHEREGNUM] = {
	...
	0x00, /* REG_ARXL1_APGA_CTL	(0x19)	*/
	0x00, /* REG_ARXR1_APGA_CTL	(0x1A)	*/
	0x33, /* REG_ARXL2_APGA_CTL	(0x1B)	*/	// 20100828 junyeop.kim@lge.com, vol tuning for media(HW require) [START_LGE]
	0x33, /* REG_ARXR2_APGA_CTL	(0x1C)	*/	// 20100828 junyeop.kim@lge.com, vol tuning for media(HW require) [END_LGE]
	0x00, /* REG_ATX2ARXPGA		(0x1D)	*/
	0x00, /* REG_BT_IF		(0x1E)	*/
	0x00, /* REG_BTPGA		(0x1F)	*/
	0x00, /* REG_BTSTPGA		(0x20)	*/
	0x20, /* REG_EAR_CTL		(0x21)	*/ /* LGE_CHANGE [iggikim@lge.com] 2009-07-7, audio path */
	0x24, /* REG_HS_SEL		(0x22)	*/
	0x0a, /* REG_HS_GAIN_SET	(0x23)	*/
	0x00, /* REG_HS_POPN_SET	(0x24)	*/
	0x20, /* REG_PREDL_CTL		(0x25)	*/ // 20100520 junyeop.kim@lge.com, headset tuning for media(HW require) [START_LGE]
...
static const twl_reg_type twl_vt_receiver_call_tab[] =
{
    ...
    {TWL4030_CMD ,0x48, 0x12},//20110128 2d->24  //20110315 seungdae.goh@lge.com  NXP_EC_MCBSP3
    ...
    {TWL4030_CMD ,0x44, 0x33},	//20110315 seungdae.goh@lge.com  NXP_EC_MCBSP3
    ...
    {TWL4030_CMD ,0x0c, 0x00},	//20110128 00->03  //20110315 seungdae.goh@lge.com  NXP_EC_MCBSP3
...
static const twl_reg_type twl_vt_headset_call_tab[] =
{
    {TWL4030_CMD ,0x01, 0x92},
    {TWL4030_CMD ,0x02, 0xdf},
    {TWL4030_CMD ,0x48, 0x1B},	//  2d --> 24 H/W changes	//20110315 seungdae.goh@lge.com  NXP_EC_MCBSP3
    {TWL4030_CMD ,0x0f, 0x61},
	{TWL4030_CMD ,0x08, 0x00},
    ...
    {TWL4030_CMD ,0x17, 0x1c},
    {TWL4030_CMD ,0x15, 0x00},
    {TWL4030_CMD ,0x44, 0x2b},	// 20101011 junyeop.kim@lge.com,voice call tuning (HW request) [START_LGE]  //20110315 seungdae.goh@lge.com  NXP_EC_MCBSP3
    {TWL4030_CMD ,0x21, 0x30},
    {TWL4030_CMD ,0x1b, 0x2b},	//20100908, junyeop.kim@lge.com, workaround for call playback sound
    {TWL4030_CMD ,0x1c, 0x2b},	//20100908, junyeop.kim@lge.com, workaround for call playback sound
    {TWL4030_CMD ,0x0c, 0x04},		//0x05 --> 0x03 --> 0x00 H/W Changes  //20110315 seungdae.goh@lge.com  NXP_EC_MCBSP3
...
static const twl_reg_type twl_vt_speaker_call_tab[] =
{
    {TWL4030_CMD ,0x01, 0x92},
    {TWL4030_CMD ,0x02, 0xdf},
    {TWL4030_CMD ,0x48, 0x24},	// 24 ( 20110128 - H/W Changes) 
    {TWL4030_CMD ,0x0f, 0x61},
	{TWL4030_CMD ,0x08, 0x00},
    {TWL4030_CMD ,0x04, 0x02},
    {TWL4030_CMD ,0x05, 0x71},
    ...
    {TWL4030_CMD ,0x17, 0x1c},
    {TWL4030_CMD ,0x15, 0x00},
    {TWL4030_CMD ,0x44, 0x2b},	//20110418 seungdae.goh@lge.com  0x2b --> 0x23 --> 0x2b
    
    {TWL4030_CMD ,0x1b, 0x23},	// 1b --> 23 ( 20110128 - H/W Changes) 
    {TWL4030_CMD ,0x1c, 0x33},	// 23(4dB) --> 33(0dB) ( 20110217 - H/W Changes) 
    {TWL4030_CMD ,0x0c, 0x01},	//20110315 seungdae.goh@lge.com  NXP_EC_MCBSP3
    ...
    {TWL4030_CMD ,0x25, 0x15},
    {TWL4030_CMD ,0x26, 0x15},
    {TWL4030_END_SEQ,0x00,0x00}	
};
...
static const twl_reg_type twl_receiver_call_dmb_tab[] =
{
    ...
    {TWL4030_CMD ,0x0f, 0x61},
	{TWL4030_CMD ,0x08, 0x00},
    {TWL4030_CMD ,0x04, 0x03},	 // 20101231 seungdae.goh@lge.com  MICBIAS2 disable  3 --> 1 --> 3
    {TWL4030_CMD ,0x05, 0x71}, 
//    {TWL4030_CMD ,0x07, 0x0a},
    {TWL4030_CMD ,0x07, 0x08},	//20100916 junyeop.kim@lge.com, only ADC L enable
    {TWL4030_CMD ,0x17, 0x1c}, 
...
static const twl_reg_type twl_headset_call_tab[] =
{
    {TWL4030_CMD ,0x01, 0x92},
    {TWL4030_CMD ,0x02, 0xdf},
    {TWL4030_CMD ,0x48, 0x1b}, //gsd_mp_test
    {TWL4030_CMD ,0x0f, 0x61},
	{TWL4030_CMD ,0x08, 0x00},
    {TWL4030_CMD ,0x04, 0x02}, // 20101231 seungdae.goh@lge.com  MICBIAS2 disable  2 --> 0 --> 2
    {TWL4030_CMD ,0x05, 0x72},
    {TWL4030_CMD ,0x07, 0x08},
    {TWL4030_CMD ,0x17, 0x1c},
    {TWL4030_CMD ,0x15, 0x00},
    {TWL4030_CMD ,0x14, 0x22},

    {TWL4030_CMD ,0x44, 0x2b},

    {TWL4030_CMD ,0x21, 0x30},
    {TWL4030_CMD ,0x1b, 0x2b},
    {TWL4030_CMD ,0x1c, 0x2b},	// 20110404  seungdae.goh@lge.com error fix
    //{TWL4030_CMD ,0x1d, 0x34},	//20110317 seungdae.goh  

	
    {TWL4030_CMD ,0x0c, 0x04}, //gsd_mp_test
    {TWL4030_CMD ,0x0d, 0x05},

    {TWL4030_CMD ,0x25, 0x00},
    {TWL4030_CMD ,0x26, 0x00},
    {TWL4030_CMD ,0x22, 0x29},
    {TWL4030_CMD ,0x23, 0x05},
...
static const twl_reg_type twl_speaker_call_tab[] =
{
    ...
    {TWL4030_CMD ,0x17, 0x1c},
    {TWL4030_CMD ,0x15, 0x00},
    {TWL4030_CMD ,0x14, 0x26},
    {TWL4030_CMD ,0x44, 0x2b}, //20110418 seungdae.goh@lge.com  0x2b --> 0x23 --> 0x2b

    {TWL4030_CMD ,0x1b, 0x1b},
    {TWL4030_CMD ,0x1c, 0x1b},
    {TWL4030_CMD ,0x0c, 0x01},
...
//    {TWL4030_CMD ,0x44, 0x33},
    ...
    {TWL4030_CMD ,0x1b, 0x2b},	//20100908, junyeop.kim@lge.com, workaround for call playback sound
    {TWL4030_CMD ,0x1c, 0x2b},	//20100908, junyeop.kim@lge.com, workaround for call playback sound
    {TWL4030_CMD ,0x0c, 0x04},	//20110227  seungdae.goh@lge.com
    {TWL4030_CMD ,0x0d, 0x00},	//20100912, junyeop.kim@lge.com, voice call tuning
    {TWL4030_CMD ,0x21, 0x30},	//20100912, junyeop.kim@lge.com, workaround for call playback sound
//    {TWL4030_CMD ,0x25, 0x10},	//20100916 junyeop.kim@lge.com, don't use reg.
//    {TWL4030_CMD ,0x26, 0x10},	//20100916 junyeop.kim@lge.com, don't use reg.
...
static const twl_reg_type twl_headset_call_tab[] =
{
    {TWL4030_CMD ,0x01, 0x92},
    {TWL4030_CMD ,0x02, 0xdf},
    {TWL4030_CMD ,0x48, 0x24},	//20110320 seungdae.goh@lge.com
    {TWL4030_CMD ,0x0f, 0x61},
    {TWL4030_CMD ,0x08, 0x00},
    {TWL4030_CMD ,0x04, 0x02},
    {TWL4030_CMD ,0x05, 0x72},
    ...
    {TWL4030_CMD ,0x17, 0x1c},
    {TWL4030_CMD ,0x15, 0x00},
    {TWL4030_CMD ,0x44, 0x33},	//20110320 seungdae.goh@lge.com 0x33 --> 0x2b
    {TWL4030_CMD ,0x21, 0x30},
    {TWL4030_CMD ,0x1b, 0x2b},	//20100908, junyeop.kim@lge.com, workaround for call playback sound
    {TWL4030_CMD ,0x1c, 0x2b},	//20100908, junyeop.kim@lge.com, workaround for call playback sound
    {TWL4030_CMD ,0x0c, 0x05},		//20110320 seungdae.goh@lge.com  5-->4
...
static const twl_reg_type twl_speaker_call_tab[] =
{
    ...
    {TWL4030_CMD ,0x15, 0x00},
    {TWL4030_CMD ,0x44, 0x33},
    {TWL4030_CMD ,0x1b, 0x1b},	//20110224, mikyoung.chang@lge.com HW request
    {TWL4030_CMD ,0x1c, 0x1b},	//20110224, mikyoung.chang@lge.com HW request
    {TWL4030_CMD ,0x0c, 0x00},		//20100912, junyeop.kim@lge.com, voice call tuning 
    {TWL4030_CMD ,0x0d, 0x00},		//20100912, junyeop.kim@lge.com, voice call tuning
    {TWL4030_CMD ,0x12, 0x3f},		 
    {TWL4030_CMD ,0x13, 0x3f},		
    {TWL4030_CMD ,0x21, 0x10},
    {TWL4030_CMD ,0x22, 0x09},
    {TWL4030_CMD ,0x25, 0x15},//20110224, mikyoung.chang@lge.com HW request
    {TWL4030_CMD ,0x26, 0x15},//20110224, mikyoung.chang@lge.com HW request
    {TWL4030_END_SEQ,0x00,0x00}	
};
...
static const twl_reg_type twl_headphone_call_tab[] =
{
    ...
    {TWL4030_CMD ,0x17, 0x1c},
    {TWL4030_CMD ,0x15, 0x00},
    {TWL4030_CMD ,0x44, 0x33},	// 20110126  mikyoung.chang@lge.com 
    {TWL4030_CMD ,0x1b, 0x2b},	//20100908, junyeop.kim@lge.com, workaround for call playback sound
    {TWL4030_CMD ,0x1c, 0x2b},	//20100908, junyeop.kim@lge.com, workaround for call playback sound
...
// [bsnoh@ubiquix][20110528] : Added code from froyo Justin [End]
// [bsnoh@ubiquix][20110528] : Added code from froyo hub [Start]
#elif defined(CONFIG_PRODUCT_LGE_HUB) /* LGE_CHANGE_S [iggikim@lge.com] 2009-08-06, audio path */
static const twl_reg_type twl_receiver_call_tab[] =
{
    {TWL4030_CMD ,0x01, 0x92}, 
    {TWL4030_CMD ,0x02, 0xdf}, 
...
//    {TWL4030_CMD ,0x14, 0x19},	// 20100912 junyeop.kim@lge.com,voice call tuning (HW request) [START_LGE]
//    {TWL4030_CMD ,0x44, 0x33},
    {TWL4030_CMD ,0x44, 0x3b},	// 20100924 junyeop.kim@lge.com,voice call tuning (HW request) [START_LGE]
    {TWL4030_CMD ,0x1b, 0x2b},	//20100908, junyeop.kim@lge.com, workaround for call playback sound
    {TWL4030_CMD ,0x1c, 0x2b},	//20100908, junyeop.kim@lge.com, workaround for call playback sound
    {TWL4030_CMD ,0x0c, 0x00},	//20100912, junyeop.kim@lge.com, voice call tuning 
    {TWL4030_CMD ,0x0d, 0x00},	//20100912, junyeop.kim@lge.com, voice call tuning
...
//    {TWL4030_CMD ,0x14, 0x19},	// 20100912 junyeop.kim@lge.com,voice call tuning (HW request) [START_LGE]
//    {TWL4030_CMD ,0x44, 0x33},
    {TWL4030_CMD ,0x44, 0x3b},	// 20100920 junyeop.kim@lge.com,voice call tuning (HW request) [START_LGE]
	{TWL4030_CMD ,0x1b, 0x2b},	//20100908, junyeop.kim@lge.com, workaround for call playback sound
	{TWL4030_CMD ,0x1c, 0x2b},	//20100908, junyeop.kim@lge.com, workaround for call playback sound
	{TWL4030_CMD ,0x0c, 0x00},	//20100912, junyeop.kim@lge.com, voice call tuning 
	{TWL4030_CMD ,0x0d, 0x00},	//20100912, junyeop.kim@lge.com, voice call tuning
...
static const twl_reg_type twl_headset_call_tab[] =
{
	...
	{TWL4030_CMD ,0x15, 0x00},
//    {TWL4030_CMD ,0x14, 0x19},	// 20100912 junyeop.kim@lge.com,voice call tuning (HW request) [START_LGE]
//    {TWL4030_CMD ,0x44, 0x03},
    {TWL4030_CMD ,0x44, 0x2b},	// 20101011 junyeop.kim@lge.com,voice call tuning (HW request) [START_LGE]
	{TWL4030_CMD ,0x21, 0x30},
	{TWL4030_CMD ,0x1b, 0x2b},	//20100908, junyeop.kim@lge.com, workaround for call playback sound
	{TWL4030_CMD ,0x1c, 0x2b},	//20100908, junyeop.kim@lge.com, workaround for call playback sound
    {TWL4030_CMD ,0x0c, 0x02},		//20101011, junyeop.kim@lge.com, voice call tuning 
    {TWL4030_CMD ,0x0d, 0x00},		//20100912, junyeop.kim@lge.com, voice call tuning
//    {TWL4030_CMD ,0x25, 0x10},	//20100916 junyeop.kim@lge.com, don't use reg.
//    {TWL4030_CMD ,0x26, 0x10},	//20100916 junyeop.kim@lge.com, don't use reg.
	{TWL4030_CMD ,0x25, 0x00},	//20100916 junyeop.kim@lge.com, don't use reg. shut down
...
static const twl_reg_type twl_speaker_call_tab[] =
{
    {TWL4030_CMD ,0x01, 0x92},
    {TWL4030_CMD ,0x02, 0xdf},
    {TWL4030_CMD ,0x48, 0x24},	// 20100927 junyeop.kim@lge.com,voice call tuning (HW request) [START_LGE]
    {TWL4030_CMD ,0x0f, 0x61},
	{TWL4030_CMD ,0x08, 0x00},
    {TWL4030_CMD ,0x04, 0x01},
    {TWL4030_CMD ,0x05, 0x71},
...
{
    {TWL4030_CMD ,0x0f, 0x61},	// original 0x61
...
#if defined(CONFIG_PRODUCT_LGE_JUSTIN) || defined(CONFIG_PRODUCT_LGE_BLACK) || defined(CONFIG_PRODUCT_LGE_HUB) // 20100618 junyeop.kim@lge.com, call path [START_LGE}
...
#if defined(TWL_READ_REG_NO_CACHE)
static inline unsigned int twl4030_read(struct snd_soc_codec *codec,
	unsigned int reg)
{
    unsigned int data = 0;
    twl_i2c_read_u8(TWL4030_MODULE_AUDIO_VOICE, (u8*)&data, (u8)reg);
...
#if defined(CONFIG_PRODUCT_LGE_JUSTIN) || defined(CONFIG_PRODUCT_LGE_BLACK) || defined(CONFIG_PRODUCT_LGE_HUB) /* 20100618 junyeop.kim@lge.com, call path */
...
/* Handsfree Left */
static const char *twl4030_handsfreel_texts[] = {"Voice", "AudioL1",
						"AudioL2", "AudioR2"};
...
/* Handsfree Right */
static const char *twl4030_handsfreer_texts[] = {"Voice", "AudioR1",
						"AudioR2", "AudioL2"};
...
static const char *twl4030_vibra_texts[] = {"AudioL1", "AudioR1",
					"AudioL2", "AudioR2"};
...
static const char *twl4030_vibrapath_texts[] = {"Local vibrator", "Audio"};
...
static const char *twl4030_micpathtx2_texts[] = {"Analog", "Digimic1"};
		...
		struct snd_kcontrol *kcontrol, int event)
{
    ...
    if(twl4030->is_calling)
    	return 0;
#elif defined(CONFIG_PRODUCT_LGE_JUSTIN) || defined(CONFIG_PRODUCT_LGE_BLACK)/* 20100913 junyeop.kim@lge.com, fix the headset call path */
...
static const struct snd_soc_dapm_route intercon[] = {
	...
	/* Physical outputs */
//#if 0  //junyeop.kim@lge.com
#if 1  //bsnoh@ubiquix : refference from GB version of Black
...
#elif defined(CONFIG_PRODUCT_LGE_JUSTIN) || defined(CONFIG_PRODUCT_LGE_BLACK)
...
//20101222 inbang.park@lge.com Wake lock for  FM Radio [END]		
	...
	wm9093_ext_suspend();
	#endif
#endif // #elif defined(CONFIG_PRODUCT_LGE_JUSTIN) || defined(CONFIG_PRODUCT_LGE_BLACK)
...
#if defined(CONFIG_PRODUCT_LGE_JUSTIN) || defined(CONFIG_PRODUCT_LGE_BLACK) || defined(CONFIG_PRODUCT_LGE_HUB) /* LGE_CHANGE_S [iggikim@lge.com] 2009-08-06, audio path */
	    ...
	    case TWL4030_RESTORE_MIC_MODE :  
	    	switch(cur_twl_mode) {
			    ...
			    case TWL4030_SPEAKER_CALL_MODE :  set_voice_table((twl_reg_type*)&twl_speaker_mic_tab[0]);
					#if (defined(CONFIG_PRODUCT_LEG_JUSTIN) || defined(CONFIG_PRODUCT_LGE_BLACK))
			    	if(get_headset_type() == HUB_NONE /*&& get_dmb_status() == 0*/)
...
#if defined(CONFIG_PRODUCT_LGE_JUSTIN) || defined(CONFIG_PRODUCT_LGE_BLACK) || defined(CONFIG_PRODUCT_LGE_HUB)
...
#if defined(CONFIG_PRODUCT_LGE_JUSTIN) || defined(CONFIG_PRODUCT_LGE_BLACK) || defined(CONFIG_PRODUCT_LGE_HUB) /* LGE_CHANGE_S [iggikim@lge.com] 2009-11-04, call path */
